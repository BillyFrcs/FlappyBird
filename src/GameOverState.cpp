...
BillyEngine::GameOverState::GameOverState(GameDataPtr gameData, int scoreGame) :
	_gameData(gameData),
	_scoreGame(scoreGame)
{
}
...
void BillyEngine::GameOverState::Init()
{
	...
	readFileHighScore.open("Score/ScoreGame_FlappyBird.txt"); // Can set the file path or directory location to save it
	...
	// Write the file
	std::ofstream writeFileHighScore("Score/ScoreGame_FlappyBird.txt"); // Can set the file path or directory location to save it
